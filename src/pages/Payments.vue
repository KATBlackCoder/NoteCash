  ...
  <MainLayout>
    <div class="content-container">
      <n-space vertical size="large">
        ...
        <!-- Success message -->
        <n-alert v-if="showSuccess" type="success" closable @close="showSuccess = false">
          Payment added successfully! <n-button text type="primary" @click="goToDashboard">View all payments</n-button>
        </n-alert>
      </n-space>
    </div>
  </MainLayout>
